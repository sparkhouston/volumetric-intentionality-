...
const CSS = `
  ...
  * { box-sizing:border-box; margin:0; padding:0; }
  ...
  /* MIND DUMP */
  .dump-wrap { height:calc(100vh - 160px); display:flex; flex-direction:column; overflow:hidden; }
  .dump-messages { flex:1; padding:20px 0; display:flex; flex-direction:column; gap:16px; overflow-y:auto; -webkit-overflow-scrolling:touch; }
