...
const CSS = `
  ...
  * { box-sizing:border-box; margin:0; padding:0; }
  ...
  .hfab { background:rgba(26,86,219,0.85); color:#fff; box-shadow:0 2px 24px rgba(26,86,219,0.3); animation:none; }
  ...
  .heaven-title { color:#1240b0; animation:none; }
...
const LiveClock = memo(function LiveClock({ style }) {
  ...
  useEffect(() => {
    const interval = setInterval(() => setT(new Date()), 1000);
      ...
      <div className="dump-messages">
        ...
        {aiLoading && (
          <div className="msg msg-ai">
            <div className={`msg-bubble ${isH?"heaven-ai-bubble":"earth-ai-bubble"}`} style={{animation:"softPulse 1.2s ease-in-out infinite"}}>
